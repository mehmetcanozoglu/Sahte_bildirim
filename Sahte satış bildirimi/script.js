...
const getRandomDisplayTime = () => Math.random() * (2 - 3) + 3;
const showAlert = () => {
  ...
  productText.innerHTML = `<p class="message">
  ${randomName} purchased ${name}</p> 
...
closeAlertBtn.addEventListener("click", () => {
  ...
  setTimeout(showAlert, Math.floor(getRandomDisplayTime()) * 300);
});
